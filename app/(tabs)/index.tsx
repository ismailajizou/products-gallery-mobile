...
export default function HomeScreen() {
  const { state, setCategory, setSort, setSearch, toggleFavorite, favorites } = useProducts();
      ...
      <View style={styles.filters}>
        ...
        <View style={[styles.filtersRow, isTablet ? styles.filtersRowTablet : styles.filtersRowPhone]}>
          ...
          <View style={[styles.filterContainer, isTablet && styles.filterContainerTablet]}>
            ...
            <View style={styles.pickerWrapper}>
              <Picker selectedValue={state.sort} onValueChange={itemValue => setSort(itemValue)} style={styles.picker}>
                <Picker.Item label="Select Sort" value="" />
                {SORT_OPTIONS.map(sort => (
                  <Picker.Item key={sort.value} label={sort.label} value={sort.value} />
                ))}
              </Picker>
            </View>
          </View>
